		...
		<form id="general_form">
			<div class="mb-3 row">
				<div class="col-6">
					...
					<div class="col-sm-10">
						<input type="text" id="name" name="name" class="form-control" maxlength="70">
			...
			<div class="mb-3 row">
				...
				<div class="col-6">
					...
					<div class="col-sm-10">
						<input type="text" id="identification" name="identification" class="form-control" maxlength="50">
...
<script type="text/javascript" src="<?php echo  base_url("assets/js/modules/owner/owner_add.js"); ?>"></script>
