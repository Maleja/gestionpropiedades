...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
	<a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="https://www.quercu.com/" target="_blank">
		<img src="<?php echo base_url('assets/img/logo-quercu-white.png'); ?>" width="40" height="40"/>
		<span class="ms-1">Property Management</span>
	</a>
