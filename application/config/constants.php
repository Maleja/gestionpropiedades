...
// Messages
//------------------------------------------------------------------------
define('ERROR_CONSULT', 'An error occurred when making the query'); 
define('ERROR_GENERAL', 'Error in the application'); 
define('MESSAGE_CONSULT_NO_RECORD', 'The query did not yield results'); 
